...
def setup():
    shelltools.system("rpm2targz -v %s/teamviewer_12*.i686.rpm" %get.workDIR())
    shelltools.system("tar xfvz %s/teamviewer_12*.i686.tar.gz --exclude=var --exclude=etc --exclude=usr" %get.workDIR())
